...
const PNL_FIELDS = {
  ...
  mktConsult: F('Marketing Consultants', 'aud', 'Marketing consultancy cost (GPAM overhead layer). Optional line in the sheet.', { sensitive: true }),
  creative:   F('Content & Creative', 'aud', 'Content and creative production cost (GPAM overhead layer). Optional line in the sheet.', { sensitive: true }),
